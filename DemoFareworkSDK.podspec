#
#  Be sure to run `pod spec lint DemoFareworkSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "IMiMineDigital"
  # spec.authors            = { "IMiMineDigital" => "48542324+IMiMineDigital@users.noreply.github.com" }
  # spec.social_media_url   = "https://twitter.com/IMiMineDigital"
